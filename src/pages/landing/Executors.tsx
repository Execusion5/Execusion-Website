...
export default function Executors() {
    return (
        <section id='about' className='mb-[20%]'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-x-10 lg:flex-row items-center'>
                <div className='bg-[#111111] px-8 py-12 flex flex-col justify-between h-[400px] rounded-lg border border-gray '>
