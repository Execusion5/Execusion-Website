...
export function TestimonialSlider() {
    return (
        <Carousel
            ...
            className="w-full mx-auto h-[400px] flex items-center bg-[#111111] border border-gray rounded-md"
        >
            <CarouselContent>
                {Array.from({ length: 4 }).map((_, index) => (
                    <CarouselItem key={index} className="basis-full sm:basis-1/2 p-8 border-r h-full border-gray">
                        <div className="grid grid-cols-5">
                            <div className="col-span-1 flex justify-center">
                                <div>
                                    <img src={'https://img.freepik.com/premium-photo/cartoon-game-avatar-logo-gaming-brand_902820-465.jpg'} className="rounded-full" width={80} height={80} />
                                </div>
                            </div>
